        ...
        <div class="row g-5">
            <div class="col-md-6">
                ...
                <ul class="icon-list ps-0">
                    <li class="d-flex align-items-start mb-1"><a href="http://localhost/" rel="noopener" target="_blank">Inicio</a></li>
                    <li class="d-flex align-items-start mb-1">MongoDB :: u:root p:secret</li>
                </ul>
            </div>
